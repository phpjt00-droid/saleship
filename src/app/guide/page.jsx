...
export default function GuidePage() {
  return (
    <div className="policy-container">
      ...
      <section>
        <h2>1. 핫딜 정보 확인</h2>
        <p>메인 화면과 핫딜 게시판에서 실시간으로 업데이트되는 세일즈 정보를 확인할 수 있습니다. 카테고리 필터를 사용하여 관심 있는 분야의 정보만 골라보세요.</p>
      </section>

      <section>
        <h2>2. 글쓰기 및 소통</h2>
        <p>로그인 후 우측 상단의 '글쓰기' 버튼을 통해 나만 아는 핫딜을 공유하거나, 자유게시판에서 동료들과 대화할 수 있습니다.</p>
      </section>
