...
import { Github, Twitter, Youtube, Instagram, Mail, Phone, MapPin, ExternalLink, ShieldCheck, FileText, HelpCircle, Heart, Link as LinkIcon } from 'lucide-react'
import './Footer.css'
        ...
        <div className="footer__grid">
          ...
          <div className="footer__brand">
            <Link href="/" className="footer__logo">
              <LinkIcon className="footer__logo-icon" size={24} />
              <span>세일쉽</span>
            </Link>
